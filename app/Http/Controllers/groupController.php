...
//     // Sirf creator hi members add kar sakta hai
//     if ($group->created_by !== auth()->id()) {
//         abort(403, 'You are not allowed to add members to this group.');
//     }
...
//     // Phone number se user nikaalo
//     $user = \App\Models\User::where('phone_number', $validated['phone_number'])->first();

//     if (!$user) {
//         return back()->with('error', 'No user found with this phone number.');
//     }

//     // Check agar already member hai
